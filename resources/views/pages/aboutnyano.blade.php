...
<div class="nyano-container">
  <section class="nh-section">
   ...
   <section class="nh-section" style="background: #e8f5e9;">
                ...
                <p>
                    Nyano Haath is a social-impact organization. To operate our platform, ensure every transaction is secure, and provide support to our users, <strong>we apply a small platform fee of 3-5% to each donation.</strong>
                </p>
                <p>
   ...
   <section class="nh-cta">
    ...
    <a href="#start" class="btn btn-primary btn-large">Start a Campaign</a>
    <a href="#explore" class="btn btn-primary btn-large">Explore Causes</a>
  </section>
